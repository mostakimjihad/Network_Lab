...
public class Client{
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("Connected at server’s handshaking port no: "+socket.getPort());
		System.out.println("Client’s is connecting at communication port "+socket.getLocalPort());
...
class client_receive extends Thread{
	...
	public client_receive(Socket skt){
